trigger RejectDoubleBooking on Session_Speaker__c (before insert, before update) {
  ...
  System.debug('the keyset is ' + requested_bookings.keySet());
  ...
  List<Session_Speaker__c> related_speakers = [SELECT Id,
  Speaker__c, Session__c, Session__r.Session_Date__c from Session_Speaker__c
